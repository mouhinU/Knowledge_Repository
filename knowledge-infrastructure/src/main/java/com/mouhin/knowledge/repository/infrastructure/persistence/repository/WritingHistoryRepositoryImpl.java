 ...
 */
@Repository
public class WritingHistoryRepositoryImpl implements WritingHistoryRepository {

    private final WritingHistoryMapper writingHistoryMapper;

    public WritingHistoryRepositoryImpl(WritingHistoryMapper writingHistoryMapper) {
