 ...
 * Embedding 模型配置
 * <p>
 * 通过 knowledge.embedding.provider 配置项切换 Embedding 模型提供商：
 * <ul>
...
public class EmbeddingModelConfig {
    ...
    public EmbeddingModel dashScopeEmbeddingModel(
            ...
            @Value("${knowledge.embedding.dashscope.model-name:text-embedding-v3}") String modelName) {
    ...
    public EmbeddingModel ollamaEmbeddingModel(
            @Value("${knowledge.embedding.ollama.base-url:http://localhost:11434/v1}") String baseUrl,
