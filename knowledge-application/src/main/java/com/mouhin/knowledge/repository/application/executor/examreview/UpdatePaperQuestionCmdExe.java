 ...
 * 供前端即时反馈是否已满足发布条件。不自动改变试卷状态（发布须由 {@link ApprovePaperCmdExe} 触发）。</p>
 *
...
public class UpdatePaperQuestionCmdExe {
    ...
    public UpdatePaperQuestionCmdExe(PaperReviewSupport support,
    ...
    @Transactional
    public ExamContractValidator.Result execute(String sessionKey, Integer questionNumber,
        ...
        examQuestionGateway.updateCorrection(sessionKey, questionNumber, correctAnswer, analysis, maxScore);
