...
public class ExamUpdateQuestionsJsonCmdExe {
    ...
    private static final Logger logger = LoggerFactory.getLogger(ExamUpdateQuestionsJsonCmdExe.class);

    private final ExamSessionGateway examSessionGateway;
    private final ExamTakingSupport support;

    public ExamUpdateQuestionsJsonCmdExe(ExamSessionGateway examSessionGateway, ExamTakingSupport support) {
