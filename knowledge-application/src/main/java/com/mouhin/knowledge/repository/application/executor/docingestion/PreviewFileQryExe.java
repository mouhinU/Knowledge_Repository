 ...
 * <p>
 * 逻辑原样迁移自 {@code DocumentIngestionApplicationService.preview(MultipartFile,...)}。出入参含
 * {@link MultipartFile}（传输耦合），当前无适配层调用点，作为完整用例保留。
 * </p>
 *
...
public class PreviewFileQryExe {
    ...
    public PreviewFileQryExe(DocumentIngestionSupport support,
