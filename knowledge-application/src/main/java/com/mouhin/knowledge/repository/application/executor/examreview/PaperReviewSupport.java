 ...
 * <p>
 * 收敛「按试卷标识加载历史 / 解析方案 / 读取结构化题目 / 复跑契约校验」这几步，
 * 供待校对列表、逐题校对视图、就地编辑回写、批准发布、重切分等执行器复用，
...
public class PaperReviewSupport {
    ...
    public PaperReviewSupport(ExamHistoryGateway examHistoryGateway,
    ...
    public ExamHistory requireHistory(String sessionKey) {
        ...
        return examHistoryGateway.findBySessionId(sessionKey)
