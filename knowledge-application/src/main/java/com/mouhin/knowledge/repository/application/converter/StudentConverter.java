 ...
 *
 * <p>映射与原 {@code StudentAuthController.me} 一致：displayName null→username，
 * studentNo null→""。不输出密码 / 令牌字段。</p>
 *
...
public final class StudentConverter {
    ...
    public static StudentVO toVO(Student student) {
        ...
        vo.setDisplayName(student.getDisplayName() != null ? student.getDisplayName() : student.getUsername());
