 ...
 *
 * <p>屏蔽 ChatModel / Prompt / 分阶段编排等技术细节，应用层仅依赖本接口获取已归一化
 * （Σ=满分）的 {@link ExamPlan}。</p>
 *
...
public interface ExamDistributionGateway {
     ...
     * @return 已归一化的分布方案
     */
    ExamPlan generate(String topic, String difficulty, String schoolLevelCode, String knowledgeHint);
     ...
     */
    ExamPlan generate(String topic, String difficulty, String schoolLevelCode,
