 ...
 *
 * <p>屏蔽具体向量库（Milvus / LangChain4j EmbeddingStore）技术细节，应用层仅依赖本接口，
 * 出入参均为领域对象。</p>
 *
...
public interface VectorStoreGateway {
     ...
     * 语义检索（带权限过滤表达式与分类过滤）
     */
    List<SearchResult> search(String query, int maxResults, double minScore, String filterExpr, String category);
