 ...
 * <p>
 * 锁定「两种空全部相加」口径：连续下划线空（半角 {@code __}/{@code ＿＿}）与空括号
 * （{@code （ ）}/{@code ( )}）各自命中后累加，而非旧版「任一类先达 2 个即短路返回」。
 * 该口径同时供出卷切分落库 {@code blank_count}、学生端 questionsJson.blankCount 与考试端
...
class ExamBlankCounterTest {
    ...
    void countsBothUnderscoreAndBracket() {
        // 2 处下划线空 + 3 处中文空括号 = 5
        String text = "边长是____厘米的正方形，周长是____分米；面积是（  ）平方分米，"
                + "合（  ）平方厘米，周长合（  ）米。";
